class SeatMap(object):
    ...
    def checkNW(self,y,x):
        ...
        x = x - 1
        y = y - 1
        if self.__grid[y][x] == self.FLOOR:
            return self.checkNW(y, x)
        else:
            return 1 if self.__grid[y][x] == self.OCCUPIED else 0
